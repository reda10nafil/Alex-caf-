...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: '🍺',
    items: [
      { id: 'heineken', name: 'Heineken', price: 2.50, image: 'https://images.unsplash.com/photo-8pyTJvV4GCQ?auto=format&fit=crop&w=800&q=80' },
      { id: 'moretti-piccola', name: 'Moretti Piccola', price: 2.50, image: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?auto=format&fit=crop&w=800&q=80' },
      { id: 'moretti-grande', name: 'Moretti Grande', price: 3.00, image: 'https://images.unsplash.com/photo-1551029506-0807df4e2031?auto=format&fit=crop&w=800&q=80' },
      { id: 'becks-piccola', name: 'Becks Piccola', price: 2.50, image: 'https://images.unsplash.com/photo-Gol-QIitbj8?auto=format&fit=crop&w=800&q=80' },
      { id: 'becks-grande', name: 'Becks Grande', price: 3.00, image: 'https://images.unsplash.com/photo-1559818488-80fb03c5c45a?auto=format&fit=crop&w=800&q=80' },
      { id: 'peroni', name: 'Peroni', price: 3.00, image: 'https://images.unsplash.com/photo-skXOiP0udaA?auto=format&fit=crop&w=800&q=80' },
      { id: 'corona', name: 'Corona', price: 3.00, image: 'https://images.unsplash.com/photo-BxVkSFiswF0?auto=format&fit=crop&w=800&q=80' },
      { id: 'ichnusa', name: 'Ichnusa', price: 3.00, image: 'https://images.unsplash.com/photo-1602143407151-7111542de6e8?auto=format&fit=crop&w=800&q=80' },
      { id: 'ceres', name: 'Ceres', price: 3.50, image: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=800&q=80' },
      { id: 'tennets', name: "Tennet's", price: 3.50, image: 'https://images.unsplash.com/photo-1566633806827-5f6d57ae5a5d?auto=format&fit=crop&w=800&q=80' },
    ],
  },
      {
    id: 'bevande',
