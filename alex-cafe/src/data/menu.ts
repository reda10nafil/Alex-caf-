...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { id: 'marocchino', name: 'Marocchino', price: 1.80, image: 'https://images.unsplash.com/photo-MjZq7A2RJxQ?auto=format&fit=crop&w=800&q=80' },
      { id: 'marocchino-nutella', name: 'Marocchino con Nutella', price: 2.00, image: 'https://images.unsplash.com/photo-MjZq7A2RJxQ?auto=format&fit=crop&w=800&q=80' },
